...
public class BackUp implements Serializable {
    ...
    private File directorioPadreCreado; // nombreDirectorioOrigen_YYYYMMDD_hhmmss

    // MÉTODOS
    // Getters + Setters
    public File getDirectorioPadreCreado() {
        return directorioPadreCreado;
    }

    public void setDirectorioPadreCreado(File directorioPadreCreado) {
        this.directorioPadreCreado = directorioPadreCreado;
    }
